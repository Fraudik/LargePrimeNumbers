...
void TrialDivisionToSqrt(benchmark::State& state, Args&&... args) {
  BenchmarkFunction(state, large_prime_numbers::TrialDivisionToSqrtPrimalityTest, std::move(args)...);
}
...
BENCHMARK_CAPTURE(TrialDivisionToSqrt, prime_3, "9999990000001")->Iterations(100)->Unit(benchmark::kMillisecond);
